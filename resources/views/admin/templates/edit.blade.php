    ...
    <div class="row">
        <div class="col-md-9">
            <div class="form-group">
                ...
                <input type="text" class="form-control form-control-sm @error('name') has-invalid @enderror" name="name" value="{{old('name') ? old('name') : $template->name}}">
                @error('name')
            ...
            <div class="form-group">
                <label>Шаблон</label>
                <textarea name="html" class="form-control form-control-sm @error('name') has-invalid @enderror" rows="10">{{old('html') ? old('html') : $template->html}}</textarea>
                @error('name')
                    <div class="invalid-feedback">
                        {{$message}}
                    </div>
